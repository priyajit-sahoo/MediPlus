...
<section class="slider">
    <div class="hero-slider">
        ...
        $args = array(
            'post_type'      => 'Carosuel',
            'posts_per_page' => -1, // Fetch all sliders
            'orderby'        => 'date',
            'order'          => 'DESC'
        );
        ...
        ?>
        <!-- Start Single Slider -->
        <div class="single-slider" style="background-image:url('<?php echo esc_url($slider_image); ?>')">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                        <div class="text">
...
<section class="blog section" id="blog">
	<div class="container">
		...
		<div class="row">
			<?php
			$args = array(
				'post_type' => 'Vehicle',  /////////////////////////// fetches post
				'posts_per_page' => -1,
				'orderby' => 'date',
				'order' => 'DESC',
			);
...
<section class="appointment">
	<div class="container">
		...
		<div class="row">
			...
			<?php echo do_shortcode('[contact-form-7 id="ce4b9db" title="Appointment" html_class="form contact-form"]');  ?>
			</div>
